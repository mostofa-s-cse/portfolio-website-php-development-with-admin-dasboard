...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO blog_tbl(title,written,date,subject,des,image)VALUES('$title','$written','$date','$subject','$des','$image')";
  
		      if (mysqli_query($conn, $sql)) {
       header("location:blog-readmore.php?msg=".urlencode("Data insert successfully"));
        ...
        <div id="edit" class="row mb-2 mt-5">
          <div class="col-sm-10  m-auto">
            <h4 class="m-0 text-dark text-center">Add New</h4>
             <hr>
            <a href="blog-readmore.php" class="btn btn-warning float-right mb-3">Back</a>
             <div class="clearfix"></div>
              <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <input type="text" class="form-control" name="written">
                      </div>
                      <div class="form-group">
