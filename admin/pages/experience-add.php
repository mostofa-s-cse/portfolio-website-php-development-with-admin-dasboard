...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO experience(timeline_title,timeline_date,timeline_des)VALUES(' $t_t',' $t_date',' $t_des')";
    if (mysqli_query($conn, $sql)) {
       header("location:experience.php?msg=".urlencode("Data insert successfully"));
    }
    else
    {
          ...
          <div class="col-sm-10  m-auto">
            ...
            <a href="experience.php" class="btn btn-warning float-right mb-3">Back</a>
             ...
             <form action="" method="POST" enctype="multipart/form-data">
                      ...
                      <input class="form-control" name="timeline_title">
                      </div>
                      <div class="form-group">
                      ...
                      <textarea class="form-control" name="timeline_des"></textarea>
                      </div>
