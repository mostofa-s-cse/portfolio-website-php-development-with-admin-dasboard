...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO work_readmore(work_btn,download,demo,image,name)VALUES('$btn','$download','$demo','$image','$name')";
    if (mysqli_query($conn, $sql)) {
      header("location:work-readmore.php?msg=".urlencode("Data insert successfully"));
    }
