...
include 'profilepic-process.php';
   if (isset($_GET['id'])) {
    ...
    $sql = "UPDATE blog_tbl SET title='$title',written='$written',date='$date',image='$image',subject='$subject',des='$des' WHERE id='$id'";
    if (mysqli_query($conn, $sql)) {
      ...
      header("location:blog-readmore.php?msg=".urlencode("Data Update successfully"));
