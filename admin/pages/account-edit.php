...
include 'profilepic-process.php';
   if (isset($_GET['id'])) {
    ...
    $sql = "UPDATE user_tbl SET name='$name', email='$email',phone='$phone',password=(MD5('$password')),image='$image' WHERE id='$id'";
    
    if (mysqli_query($conn, $sql)) {
       header("location:account.php?msg=".urlencode("Data Update successfully"));
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10  m-auto">
             ...
             <h1 class="m-0 text-dark text-center">Update Account</h1>
             <?php 
             ...
             <form action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   <label>Image</label>
                   <input type="file" name="image" value="<?php echo $row['image'];?>" class="form-control" required="">
                 </div>
