...
include 'profilepic-process.php';
   if (isset($_GET['id'])) {
    ...
    $sql = "UPDATE work_tbl SET title_span='$title_span', title='$title',work_btn='$w_b',image='$image',download='$download',demo='$demo',name='$name' WHERE id='$id'";
    
    if (mysqli_query($conn, $sql)) {
      header("location:work.php?msg=".urlencode("Data Update successfully"));
    }
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-10  m-auto">
             <h1 class="m-0 text-dark text-center">Update Work Button</h1>
             <?php 
            ...
            <form action="" method="post" enctype="multipart/form-data">
                      ...
                      <textarea class="form-control" name="download"><?php echo $row['download'];?></textarea>
                      </div>
                      <div class="form-group">
                      <label>Demo Link</label>
                      <textarea class="form-control" name="demo"><?php echo $row['demo'];?></textarea>
                      </div>
